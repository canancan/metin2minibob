...
Module Trainer 
    ...
    'Private Declare Function WriteMemoryString Lib "kernel32" Alias "WriteProcessMemory" (ByVal Handle As Integer, ByVal Address As Integer, ByRef Value As Double, Optional ByVal Size As Integer = 12, Optional ByRef Bytes As Integer = 0) As String
